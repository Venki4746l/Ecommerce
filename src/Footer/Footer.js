        ...
        <div className="row rowww pt-5">
          <div className="col-lg-4 mb-5 pr-3 pr-xl-5">
            ...
            <p className="footer-address-text mb-2">
              <svg className="pink-icon"  xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 384 512">
                <path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 256c-35.3 0-64-28.7-64-64s28.7-64 64-64s64 28.7 64 64s-28.7 64-64 64z" />
              </svg>
              123 Street, New York, USA
            </p>
            <p className="footer-address-text mb-2">
              <svg  className="pink-icon" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 512 512">
            ...
            <div className="row">
              <div className="col-md-4 d-flex flex-column mb-4">
                ...
                <a className="footer-link mb-2" href="@">
                  <svg  xmlns="http://www.w3.org/2000/svg"  className="right-arrow"  viewBox="0 0 320 512"  >
              ...
              <div className="col-md-4 mb-5">
                ...
                <form action="">
                  <div className="form-group">
                    <input  className="footer-input-field"  placeholder="Your Name"  type="text"  required/>
                  </div>
                  <div className="form-group">
                    <input  className="footer-input-field"  placeholder="Your Email"  type="email"  required/>
                  </div>
