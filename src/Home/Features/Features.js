          ...
          <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div className="d-flex align-items-center border mb-4">
              <div className="feature-container">
                ...
                <h2 style={{ fontSize: "23px" }}>Quality Product</h2>
              </div>
            </div>
          </div>
          ...
          <div className="container col-lg-3 col-md-6 col-sm-12 ">
            <div className="d-flex align-items-center border mb-4">
              <div className="feature-container">
                ...
                <h2 style={{ fontSize: "23px" }}>Free Shipping</h2>
              </div>
            </div>
          </div>
          ...
          <div className="container col-lg-3 col-md-6 col-sm-12  ">
            <div className="d-flex align-items-center border mb-4">
              <div className="feature-container">
                ...
                <h2 style={{ fontSize: "23px" }}>14-Day Return</h2>
              </div>
            </div>
          </div>
          ...
          <div className="container col-lg-3 col-md-6 col-sm-12 ">
            <div className="d-flex align-items-center border mb-4">
              <div className="feature-container">
                ...
                <h2 style={{ fontSize: "23px" }}>24/7 Support</h2>
              </div>
            </div>
          </div>
        </div>
