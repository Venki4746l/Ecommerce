        ...
        <div className="row border-top px-xl-5">
          ...
          <div className="col-lg-3 d-none d-lg-block">
            ...
            <nav
              ...
              style={{}}
            >
              <div className="navbar-nav w-100 overflow-hidden navslide" style={{ height: "410px" }}>
                <Dropdown>
                  <Dropdown.Toggle variant="white" id="dropdown-basic">Dresses
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="m-3" style={{height:"20px",width:"80px"}}>
                      <path d="M201.4 374.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 306.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" />
                    </svg>
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
