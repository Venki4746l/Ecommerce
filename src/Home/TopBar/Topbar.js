        ...
        >
          ...
          <div className="col-lg-6 d-none d-lg-block">
            <div className="d-inline-flex align-items-start justify-content-start">
              ...
              <span className="text-muted px-2">|</span>
              <Link className="text-dark text-decoration-none" to="/contactus">Support</Link>
            </div>
          </div>

          <div className="col-lg-6 text-end text-lg-right">
            <div className="d-inline-flex align-items-end">
              <a className="text-dark px-2" href="https://www.facebook.com/Maybinsefu1/">
              ...
              <addEventListener className="text-dark px-2" href="https://twitter.com/msystech">
              ...
              <a className="text-dark px-2" href="https://in.linkedin.com/company/msys-technologies">
              ...
              <a className="text-dark px-2" href="https://www.instagram.com/msys_technologies/?hl=en">
              ...
              <a className="text-dark pl-2" href="https://www.youtube.com/c/MSys-Tech">
